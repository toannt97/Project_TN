namespace ShopWebApp.Constants
{
    public static class Constant
    {
        ...
        public const string API_ORDER_DETAIL = "orderdetails";
        /*Method*/
        ...
        public const string API_GET_ODER_BY_USER = API_ORDER + "/GetOrdersByUserId";
        public const string API_GET_ODER_DETAILS_BY_ORDER = API_ORDER_DETAIL + "/GetOrderDetailsByOrderId";
        public const string API_PAYMENT_COMPLETED = API_ORDER + "/PaymentCompleted";
